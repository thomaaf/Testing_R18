...
VehicleModel2CM (const ExternalOutputs_UserVehicle_RTW *out)
{
    ...
    Vehicle.Hitch.t_0[0] = out->ToCM.Hitch.t_0.x;
    Vehicle.Hitch.t_0[1] = out->ToCM.Hitch.t_0.y;
    Vehicle.Hitch.t_0[2] = out->ToCM.Hitch.t_0.z;
    Vehicle.Hitch.v_0[0] = out->ToCM.Hitch.v_0.x;
    Vehicle.Hitch.v_0[1] = out->ToCM.Hitch.v_0.y;
    Vehicle.Hitch.v_0[2] = out->ToCM.Hitch.v_0.z;
    ...
    Vehicle.Fr1B_r_xy[0] =	out->ToCM.Fr1B_r_xy.x;
    Vehicle.Fr1B_r_xy[1] =	out->ToCM.Fr1B_r_xy.y;
    ...
    Vehicle.AeroMarkerPos[0] = out->ToCM.AeroMarkerPos.x;
    Vehicle.AeroMarkerPos[1] = out->ToCM.AeroMarkerPos.y;
    Vehicle.AeroMarkerPos[2] = out->ToCM.AeroMarkerPos.z;
